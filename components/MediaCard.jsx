...
const MediaCard = ({className}) => {
  return (
    <Link href={"/mediadetails"} className={'group/workcard w-full bg-main transition-all duration-700 border hover:bg-hover border-white/20 rounded-3xl p-3 ' + className}>
      <div className=' overflow-hidden rounded-2xl'>
        <p className='relative z-10 top-8 left-3'>News</p>
        <img className='hover:grayscale group-hover/workcard:scale-110 relative top-0 left-0 h-64 rounded-2xl w-full transition-all duration-500 cursor-pointer object-cover' src="/assets/work.webp" alt="" />
      </div>
