    ...
    <div className={'w-screen flex justify-center ' + syne.className}>
      <div className='w-9/12 h-20 px-16 rounded-full  flex justify-between items-center fixed top-5 z-50 bg-gradient-to-b from-transparent to-black/50 backdrop-blur-md'>
        ...
        <div className='flex gap-3'>
          ...
          <Link className={router.pathname === "/contactus" ? 'hover:-top-1 top-0 relative text-blue-500 duration-200 hover:bg-white/20 px-3 py-2 rounded-full' : 'hover:-top-1 top-0 relative text-white/70 hover:text-white duration-200 hover:bg-white/20 px-3 py-2 rounded-full'} href={'/'}>Contact Us</Link>
        </div>
        {/* <div>
