...
const WorkCard = ({className}) => {
  return (
    <div className={'border border-white/50 rounded-3xl p-3 ' + className}>
      <div className='relative overflow-hidden rounded-2xl'>
        <img className='rounded-2xl w-full hover:scale-110 transition duration-500 cursor-pointer object-cover' src="/assets/work.webp" alt="" />
        </div>
      <div className='p-4'>
