...
const Creation = () => {
  ...
  return (
    <Layout>
      <HeroSection heading={<p>Ad for <br />WAHL MEA</p>} para={"While we all continue the celebration of the successful #fifaworldcup2022qatar  campaign, we had the opportunity to work with WAHL MiddleEast to develop and visualize this aspirational content. "} img={"https://assets-global.website-files.com/633c3f6cb573b7ca538e9ffa/639b78f4806369ac8c0d944d_WestJet_Christmas%20Miracle.00_01_41_07.Still014-p-1080.jpg"} />
      ...
      <section className='w-screen lg:py-20 py-10 lg:px-28 px-5 grid grid-cols-12'>
        ...
        <div className='col-span-8'>
          <p className={'text-4xl leading-snug ' + syne.className}>The content and the location injected a true spirit of team work and consistency within us. Shot during the mid-summer, under the 45&#176;C! Shout out to everyone in this project GHG calculations in-line!</p>
          <div className={'text-xl py-4 font-medium flex flex-col gap-2 ' + syne.className}>
      ...
      <div className='w-full lg:py-20 py-10 lg:px-28 px-5 lg:grid hidden lg:gap-16 gap-5'>
        ...
        >
          <SwiperSlide className='rounded-3xl overflow-hidden h-64 flex justify-center items-center'><img className='h-full w-full' src="https://assets-global.website-files.com/633c3f6cb573b7ca538e9ffa/639b78f4806369ac8c0d944d_WestJet_Christmas%20Miracle.00_01_41_07.Still014-p-1080.jpg" alt="" /></SwiperSlide>
          <SwiperSlide className='rounded-3xl overflow-hidden h-64 flex justify-center items-center'><img className='h-full w-full' src="https://assets-global.website-files.com/633c3f6cb573b7ca538e9ffa/639b7937d471181c6ad7b432_WestJet_Christmas%20Miracle.00_02_32_03.Still021-p-1080.jpg" alt="" /></SwiperSlide>
          <SwiperSlide className='rounded-3xl overflow-hidden h-64 flex justify-center items-center'><img className='h-full w-full' src="https://assets-global.website-files.com/633c3f6cb573b7ca538e9ffa/639b791c647ed2ea5ef85cf0_WestJet_Christmas%20Miracle.00_02_25_15.Still022-p-1080.jpg" alt="" /></SwiperSlide>
          <SwiperSlide className='rounded-3xl overflow-hidden h-64 flex justify-center items-center'><img className='h-full w-full' src="https://assets-global.website-files.com/633c3f6cb573b7ca538e9ffa/639b7937d471181c6ad7b432_WestJet_Christmas%20Miracle.00_02_32_03.Still021-p-1080.jpg" alt="" /></SwiperSlide>
        </Swiper>
      ...
      <div className='w-full lg:py-20 py-10 lg:px-28 px-5 lg:grid hidden lg:gap-16 gap-5'>
        ...
        <div className='w-full flex flex-col items-center lg:gap-10 gap-7'>
          <div className='w-full grid lg:grid-cols-12 grid-cols-1 gap-3'>
            <Link href={'/creation'} className='group/creation lg:col-span-6 cols-span-1 h-96 overflow-hidden duration-150 rounded-3xl relative border border-white/30 '>
