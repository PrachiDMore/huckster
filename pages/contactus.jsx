          ...
          <form onSubmit={handleSubmit} className=' lg:w-3/5 w-full'>
            ...
            <div className='flex flex-col items-center gap-5 w-full '>
              <div className='lg:flex grid gap-5 w-full'>
                <input value={formState.name} required id='name' onChange={handleChange} className='outline-none text-lg bg-none bg-white/20 rounded-xl lg:px-7 px-4 py-3 w-full' type="text" placeholder='Enter your Name' />
                <input value={formState.email} required id='email' onChange={handleChange} className='outline-none text-lg bg-none bg-white/20 rounded-xl lg:px-7 px-4  py-3 w-full' type="email" placeholder='Enter your Email' />
              </div>
              <textarea value={formState.message} required id='message' onChange={handleChange} className='outline-none text-lg bg-none bg-white/20 rounded-xl  lg:px-7 px-4  py-3 w-full h-40 resize-none' type="text" placeholder='Write message...' />
