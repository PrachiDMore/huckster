  ...
  return (
    <Layout>
      ...
      <div className='w-screen lg:px-28 px-5 lg:py-20 py-10'>
        <div className='border border-white/50 rounded-2xl lg:flex grid gap-5 lg:p-8 p-4 bg-white/10'>
          <div className='lg:w-2/5 w-full'>
            ...
            <div className='flex gap-3'>
              ...
              <p className={'lg:text-lg pb-3 ' + inter.className}>123 Artistic Lane, Mumbai.</p>
            </div>
            <div className='flex gap-3'>
              <HiOutlineMail className='text-xl'/>
              <p className={'lg:text-lg pb-3 ' + inter.className}>info@hucksterproductions.com</p>
            </div>
            <div className='flex gap-3'>
              <HiOutlinePhone className='text-xl'/>
              <p className={'lg:text-lg pb-3 ' + inter.className}>1234567890</p>
            </div>
          </div>
