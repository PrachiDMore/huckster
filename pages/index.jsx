		...
		<Layout className="snapscroll">
          ...
          <img className='h-full w-full' src='assets/herosection.jpg' />
			...
			<div className='w-full py-20 px-28 grid gap-16'>
				<h1 className={'text-8xl font-semibold w-full gradientText ' + syne.className}>CREATIONS</h1>
			...
			<div className='w-full py-20 px-28 grid gap-6'>
				<h1 className={'text-8xl font-semibold  gradientText ' + syne.className}>SERVICES</h1>
